...
export default (state = INITIAL_STATE, action ) => {
    switch(action.type) {
        case "USER_LOGIN_SUCCESS" :
            return {username: action.payload.username, email: action.payload.email, error: action.payload.error, id: action.payload.id, cookieCheck: action.payload.cookieCheck};
